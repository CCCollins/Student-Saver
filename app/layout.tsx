...
export const metadata: Metadata = {
  ...
  robots: "index, follow",
  keywords: [
    "студенческий билет", "скидки", "промокоды", "акции", "купоны", "как сэкономить",
    "студенческие мероприятия", "мероприятия для студентов", "мероприятия",
    "промокод на скидку", "студенческие промокоды", "студенческая скидка",
    "скидки по студенческому билету", "льготы для студентов", "студенческие льготы",
    "предложение для студентов", "стажировка", "стажировки для студентов", "место стажировки"
  ],
