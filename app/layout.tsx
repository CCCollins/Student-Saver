...
export const metadata: Metadata = {
  ...
  robots: "index, follow",
  keywords: [
    "промокод пицца", "промокод купер", "промокод яндекс", "промокод озон", "промокод алиэкспресс", "промокод маркет",
    "афиша петербург", "промокод ру", "промокод на первый",
    "промокод аптека", "студенческие промокоды", "промокод на скидку",
    "промокоды на еду", "акции и скидки", "купоны",
    "промокод золотое", "промокоды 2025", "промокод аптека ру", "промокод яблоко"
  ],
  ...
  return (
    <html lang="ru">
      <head>
        ...
        <meta
          name="keywords"
          content="промокод пицца, промокод купер, промокод яндекс, промокод озон, промокод алиэкспресс, промокод маркет, афиша петербург, промокод ру, промокод на первый, промокод аптека, студенческие промокоды, промокод на скидку, промокоды на еду, акции и скидки, купоны, промокод золотое, промокоды 2025, промокод аптека ру, промокод яблоко"
        />
